      ...
      <div className="space-y-6">
        <p className="text-sm xs:text-base sm:text-lg text-gray-700 leading-relaxed">
          {language === "en"
            ...
            : language === "fr"
            ? "Safran d'origine éthique d'Iran, Safayra est un voyage des champs ensoleillés d'Iran au cœur de l'Europe. Nous vous apportons un safran de qualité supérieure, soigneusement cueilli à la main de son pays d'origine, où des siècles de tradition rencontrent des pratiques éthiques et modernes."
            : "Ethisch bezogener Safran aus dem Iran, Safayra ist eine Reise von den sonnenverwöhnten Feldern des Iran ins Herz Europas. Wir bringen Ihnen Premium-Qualität Safran, sorgfältig von Hand gepflückt aus seinem Ursprungsland, wo jahrhundertealte Tradition auf ethische und moderne Praktiken trifft."}
        </p>
        <p className="text-sm xs:text-base sm:text-lg text-gray-700 leading-relaxed">
          {language === "en"
        ...
        <div className="bg-amber-50 p-6 rounded-lg">
          ...
          <p className="text-sm xs:text-base text-gray-700 leading-relaxed">
            {language === "en"
              ...
              : "Diese handwerkliche Methode, kombiniert mit der Seltenheit der Ernte, macht Safran zum kostbarsten Gewürz der Welt. Wir glauben, dass Exzellenz mit Verbindung beginnt. Deshalb arbeiten wir eng mit unseren Kunden zusammen, von Köchen bis zu Einzelhändlern, um nicht nur Safran zu liefern, sondern eine durchdachte, maßgeschneiderte Erfahrung."}
          </p>
        </div>
      </div>
    </div>
