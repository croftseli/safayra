            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                {language === "en"
                  ...
                  : language === "fr"
                  ? "Avec son arôme profond, sa couleur vibrante et sa pureté inégalée, Safayra répond aux attentes des palais les plus raffinés du monde, des chefs étoilés Michelin aux créateurs artisanaux."
                  : "Mit seinem tiefen Aroma, seiner lebendigen Farbe und seiner unvergleichlichen Reinheit erfüllt Safayra die Erwartungen der raffiniertesten Gaumen der Welt, von Sterneköchen bis hin zu handwerklichen Schöpfern."}
              </p>
              <div className="bg-amber-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700 mb-4">
                  {language === "en"
                    ...
                    : language === "fr"
                    ? "Notre safran premium transforme les plats ordinaires en expériences culinaires extraordinaires. Chaque fil porte l'essence de la tradition persane séculaire, offrant :"
                    : "Unser Premium-Safran verwandelt gewöhnliche Gerichte in außergewöhnliche kulinarische Erlebnisse. Jeder Faden trägt die Essenz jahrhundertealter persischer Tradition und bietet:"}
                </p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600 text-sm">
                    {language === "en"
                      ...
                      : language === "fr"
                      ? "Approuvé par les restaurants étoilés Michelin à travers l'Europe pour sa qualité constante et son profil de saveur authentique."
                      : "Vertraut von Michelin-Sterne-Restaurants in ganz Europa für seine konstante Qualität und authentisches Geschmacksprofil."}
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-base">
                        {language === "en"
                          ? "Revives dull skin and evens out complexion"
                          : "Ravive la peau terne et unifie le teint"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-base">
                        {language === "en"
                          ? "Reduces inflammation and soothes sensitivities"
                          : "Réduit l'inflammation et apaise les sensibilités"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-base">
                        {language === "en"
                          ? "Restores softness and moisture"
                          : "Restaure la douceur et l'hydratation"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
              ...
              <div className="bg-rose-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-rose-900 mb-4">
                  {language === "en"
                    ...
                    : "Enraciné dans la tradition, perfectionné par la science"}
                </h3>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-green-900 mb-2">
                  {language === "en"
                    ? "Infusions & Aromatherapy"
                    : "Infusions et Aromathérapie"}
                </h3>
                <p className="text-green-700 font-medium mb-4">
                  {language === "en"
                    ? "→ Nature's touch in daily wellness"
                    : "→ La touche de la nature dans le bien-être quotidien"}
                </p>
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <p className="text-blue-700 font-medium mb-4">
                  {language === "en"
                    ? "→ Naturally lifting mind and mood"
                    : "→ Élever naturellement l'esprit et l'humeur"}
                </p>

                <div>
                  <h4 className="font-semibold text-blue-800 mb-2">
                    {language === "en"
                      ? "Capsules, softgels, and gummies"
                      : "Gélules, capsules molles et gommes"}
                  </h4>
                  <p className="text-gray-700 text-sm leading-relaxed">
                    {language === "en"
              ...
              <div className="bg-purple-50 p-6 rounded-lg">
                ...
                <p className="text-purple-700 font-medium mb-4">
                  → A natural ally for relaxation and recovery
                </p>

                <p className="text-gray-700 text-sm leading-relaxed mb-4">
                  Rich in active compounds with anti-inflammatory, antioxidant,
                  and soothing properties, this botanical stands out as a
                  premium ingredient in professional body care. In the form of
                  oils or creams, it finds its place in massage institutes,
                  wellness centers, and physiotherapy practices, delivering
                  measurable comfort and added value to the client experience.
                </p>

                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-purple-800 mb-2">
                      Relief of muscle tension and inflammation
                    </h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      Thanks to its active molecules, crocin, crocetin, and
                      safranal, it helps relieve localized muscle pain, reduce
                      chronic inflammation, and ease stiffness. When used in
                      therapeutic or relaxation massages, it enhances calming
                      effects and supports optimal physical recovery.
                    </p>
                  </div>

                  <div>
                    <h4 className="font-semibold text-purple-800 mb-2">
                      Antioxidant and regenerative action
                    </h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      It protects skin and muscle tissues from oxidative stress,
                      particularly in individuals exposed to intense physical
                      exertion or skin aging. Applied topically, it nourishes
                      the skin, improves elasticity, and promotes the repair of
                      micro-lesions.
                    </p>
                  </div>
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800 mb-2">
                      A natural complement to physiotherapy
                    </h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      Oil-based treatments incorporating this botanical can
                      support rehabilitation techniques by helping relieve joint
                      pain, enhance mobility, and reduce inflammation from
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800 mb-2">
                      A high-end sensory experience
                    </h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      Its warm, subtle fragrance creates a soothing atmosphere
                      that enhances the therapeutic benefits of each session.
                      This sensory dimension transforms every massage into an
              ...
              <div className="bg-pink-50 p-6 rounded-lg">
                ...
                <p className="text-pink-700 font-medium mb-4">
                  → Natural support for women's balance
                </p>

                <p className="text-gray-700 text-sm leading-relaxed mb-4">
                  Saffron is also used to support women's well-being thanks to
                  its hormone-regulating effects and anti-inflammatory
                  properties.
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-pink-800 mb-2">
                      Menstrual Comfort Supplements
                    </h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      This spice helps reduce menstrual pain, improve mood, and
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm leading-relaxed">
                      It is an ideal ally during periods of hormonal imbalance,
                      such as menopause or irregular cycles, contributing to
